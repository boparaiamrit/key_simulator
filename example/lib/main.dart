...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    // Want to Listen Clipboard Events
    KeySimulator.clipboardEventStream().listen((event) {
      if (kDebugMode) {
        print(event);
      }
    });
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = await KeySimulator.platformVersion ?? 'Unknown platform version';
